<div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav">
        ...
        <li class="dropdown" id="menu-messages"><a href="#" data-toggle="dropdown" data-target="#menu-messages" class="dropdown-toggle"><i class="icon icon-envelope"></i> <span class="text">Messages</span> <span class="label label-important"><?php echo count(Order::getAllOrder())?></span> <b class="caret"></b></a>
            <ul class="dropdown-menu">
                <li><a class="sAdd" title="" href="./message.php"><i class="icon-plus"></i> new message</a></li>
                <li class="divider"></li>
